    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$1K, { width: "24px", color: "text" }))))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://rotiswap.io/swap?outputCurrency=0x501aC27278540E889E3DbD4795fB332a2947d403", target: "_blank" },
...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1X)(templateObject_2$u || (templateObject_2$u = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var SelectWithIcon = function (_a) {
    ...
    return (React__default['default'].createElement(DropDownContainer, __assign({ isOpen: isOpen }, props),
        React__default['default'].createElement(DropDownHeader, { onClick: toggling },
            selectIconElement,
            React__default['default'].createElement(Text, null, options[selectedOptionIndex].label)),
        !isOpen && React__default['default'].createElement(Icon$1O, { color: "text", onClick: toggling }),
...
var SubMenuItems = function (_a) {
    ...
    return (React__default['default'].createElement(StyledSubMenuItems, __assign({ justifyContent: [isMobileOnly ? "flex-end" : "start", null, "center"] }, props, { pl: ["12px", null, "0px"], "$isMobileOnly": isMobileOnly }), items.map(function (_a) {
        ...
        return label && (React__default['default'].createElement(StyledBox, { key: label, pr: "20px", pl: "20px", isActive: href === activeItem },
            React__default['default'].createElement(MenuItem$1, { href: href },
...
var Th = styled__default['default'](Td).attrs({ as: "th" })(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  color: ", ";\n  font-size: 12px;\n  text-transform: uppercase;\n"], ["\n  color: ", ";\n  font-size: 12px;\n  text-transform: uppercase;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.secondary;
});
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default['default'].createElement(StyledIconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default['default'].createElement(Icon$1K, { color: "text" })));
};
...
var MenuItem = function (_a) {
    ...
    return (React__default['default'].createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px"] },
            ...
            React__default['default'].createElement(SyltedLinkArea, { order: [2, null, 1], flexDirection: ["column", null, "row"], justifyContent: "space-around", alignItems: "flex-start", mb: ["42px", null, "36px"] },
                React__default['default'].createElement(Box, { display: ["none", null, "block"] },
                    React__default['default'].createElement(Flex, null,
                        React__default['default'].createElement(Text, { color: "#fefad7", fontSize: "32px", bold: true }, "Roti"),
                        React__default['default'].createElement(Text, { color: "primary", fontSize: "32px", bold: true }, "Swap"))), items === null || items === void 0 ? void 0 :
                items.map(function (item) {
                    ...
                    return (React__default['default'].createElement(StyledList, { key: item.label },
                        ...
                        _a.map(function (_a) {
                            ...
                            return (React__default['default'].createElement(StyledListItem, { key: label }, href ? (React__default['default'].createElement(Link, { href: href, target: "_blank", rel: "noreferrer noopener", color: isHighlighted ? baseColors.warning : darkColors.text, bold: false, fontSize: "14px" }, label)) : (React__default['default'].createElement(StyledText, null, label))));
                        })));
                })),
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default['default'].createElement(Text, null, "RotiSwap 2022. All Rights Reserved"),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(Flex, null,
        ...
        React__default['default'].createElement(LogoWithTextIcon, { isDark: true, className: "desktop-icon" })));
