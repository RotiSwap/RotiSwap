...
export const Default: React.FC = () => {
  ...
  return (
    <>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="xs" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
      ...
      <Row>
        <ButtonMenu activeIndex={index} onItemClick={handleClick} variant="button">
          <ButtonMenuItem variant="button">Button 1</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 2</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 3</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 4</ButtonMenuItem>
        </ButtonMenu>
      </Row>
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="sm" variant="button" ml="24px">
          <ButtonMenuItem variant="button">Button 1</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 2</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 3</ButtonMenuItem>
          <ButtonMenuItem variant="button">Button 4</ButtonMenuItem>
