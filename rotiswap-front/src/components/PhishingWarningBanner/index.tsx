...
const PhishingWarningBanner: React.FC = () => {
  ...
  const warningText = t("please make sure you're visiting https://rotiswap.io - check the URL carefully.")
  const warningTextAsParts = warningText.split(/(https:\/\/rotiswap.io)/g)
    ...
    <>
      ...
      {warningTextAsParts.map((text) => (
        <Text
          small
          as="span"
          bold={text === 'https://rotiswap.io'}
          color={text === 'https://rotiswap.io' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
