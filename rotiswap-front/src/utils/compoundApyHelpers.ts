 ...
 * @param apr - farm or pool apr as percentage. If its farm ROI its only cake rewards ROI without LP rewards ROI
...
/**
 * Given ROI returns APY
 * @param apr ROI as percentage
