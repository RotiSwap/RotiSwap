...
import { Currency, currencyEquals, ECO, Percent, WETH } from '@pancakeswap/sdk'
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    ...
    const currencyBIsETH = currencyB === ECO
    const oneCurrencyIsETH = currencyA === ECO || currencyBIsETH
  ...
  const oneCurrencyIsETH = currencyA === ECO || currencyB === ECO
                ...
                <LightGreyCard>
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        <StyledInternalLink
                          to={`/remove/${currencyA === ECO ? WETH[chainId].address : currencyIdA}/${
                            currencyB === ECO ? WETH[chainId].address : currencyIdB
                          }`}
                        >
                          {t('Receive WECO')}
                        </StyledInternalLink>
                        ...
                        <StyledInternalLink
                          to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'ECO' : currencyIdA}/${
                            currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'ECO' : currencyIdB
                          }`}
                        >
                          {t('Receive ECO')}
                        </StyledInternalLink>
