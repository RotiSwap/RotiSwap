...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const farmsList = useCallback(
    (farmsToDisplay: DeserializedFarm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithROI: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
      ...
      if (query) {
        ...
        farmsToDisplayWithROI = farmsToDisplayWithROI.filter((farm: FarmWithStakedValue) => {
          return latinise(farm.lpSymbol.toLowerCase()).includes(lowercaseQuery)
        })
      }
      return farmsToDisplayWithROI
    },
    ...
    <>
      <Page>
        <PageHeader>
          ...
          <Heading scale="lg" color="textSubtle" mb="20px">
             {t('Your Stake will be locked for 60 days')}
          </Heading>
        </PageHeader>
        <ControlContainer>
          <ViewControls>
