...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const liquidityUrlPathParts = isTokenOnly ? swapUrl+token.address : getLiquidityUrlPathParts({
    quoteTokenAddress: quoteToken.address,
    tokenAddress: token.address,
  })
  const addLiquidityUrl = isTokenOnly ? liquidityUrlPathParts : `${BASE_ADD_LIQUIDITY_URL}/${liquidityUrlPathParts}`
