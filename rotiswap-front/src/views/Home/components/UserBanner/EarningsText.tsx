...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ROTI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ROTI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ROTI pool', data)
  }
